...
function decodeLedgerEvent(log, ledgerContract) {
...
async function logCid(cid, { config, fetch, ledgerContract, nodeAddress, transactionPreparer, timeoutMs, pollIntervalMs, id, signal, }) {
