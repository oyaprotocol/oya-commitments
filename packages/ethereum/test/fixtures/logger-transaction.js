...
export const { loggerAddress, node } = fixtures;
...
export function createLog(overrides = {}) {
    return {
        address: loggerAddress, topics: [...fixtures.topics, sample.cidKeccak256Hash], data: sample.data,
...
export function createReceipt(overrides = {}) {
    return {
        ...
        from: node, to: loggerAddress, contractAddress: null,
...
export function createOptions(overrides = {}) {
    return {
        ...
        loggerAddress, expectedNode: node, timeoutMs: 1_000, pollIntervalMs: 1,
        prepareTransaction: () => ({ rawTransaction, transactionHash }),
