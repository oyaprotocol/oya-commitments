...
export { authorizeMessageSigner, SignedMessageAuthorizationError, } from './authorization.js';
...
export type { SignedMessageAuthorizationErrorCode, } from './authorization.js';
